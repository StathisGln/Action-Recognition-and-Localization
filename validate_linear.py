...
from model_par_transl_v3_linear import Model
...
if __name__ == '__main__':
    ...
    parser.add_argument('--linear_path', '-l', help='Path of linear model', default='./linear_mean_ucf_60.pwf' )
