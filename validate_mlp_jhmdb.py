...
# from model_all_mlp import Model
# from model_all_mlp_v2 import Model
from model_all_mlp_v2_nms import Model
...
if __name__ == '__main__':
    ...
    parser.add_argument('--linear_path', '-l', help='Path of linear model', default='./linear_jhmdb_60.pwf' )
    ...
    # linear_path = './mpl_jhmdb_60.pwf'
    # linear_path = './linear_max_jhmdb_60.pwf'
