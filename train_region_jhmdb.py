...
if __name__ == '__main__':
    ...
    for epoch in range(epochs):
        ...
        if ( epoch + 1 ) % 5 == 0:
            torch.save(act_model.state_dict(), "action_net_model_only_score_3D_reg_mIoU_max_pool.pwf".format(epoch+1))
    torch.save(act_model.state_dict(), "action_net_model_only_score_3D_reg_mIoU_max_pool.pwf")
