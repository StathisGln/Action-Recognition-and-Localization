...
START_LETTER = 0
BATCH_SIZE = 32
MLE_TRAIN_EPOCHS = 100 # max likelihood training epochs
ADV_TRAIN_EPOCHS = 50  # 
...
if __name__ == '__main__':
    ...
    gen = generator.Generator(GEN_INPUT_DIM, GEN_HIDDEN_DIM, VOCAB_SIZE, MAX_SEQ_LEN, gpu=CUDA)
    dis = discriminator.Discriminator(DIS_INPUT_DIM, DIS_HIDDEN_DIM, VOCAB_SIZE, MAX_SEQ_LEN, gpu=CUDA)
