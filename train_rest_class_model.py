...
from rest_model_v1 import RestNet
...
if __name__ == '__main__':
    ...
    dataset_frames = '../UCF-101-frames'
    dataset_features = './UCF-101-features-256-7'
    ...
    file = open('train_loss_ucf_RestNet.txt', 'w')
    ...
    for epoch in range(epochs):
        ...
        if ( epoch + 1 ) % 5 == 0:
            torch.save(model.module.state_dict(), "RestNet_ucf.pwf".format(epoch+1))
