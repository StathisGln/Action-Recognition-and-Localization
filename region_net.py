...
class _RPN(nn.Module):
    ...
    def __init__(self, din, sample_duration):
        ...
        # self.anchor_duration = [8,4,2] # add 
        ...
        self.RPN_proposal_16 = _ProposalLayer_xy(self.feat_stride,  self.anchor_scales, self.anchor_ratios, [self.sample_duration])
        ...
        self.RPN_anchor_16 = _AnchorTargetLayer_xy(self.feat_stride, self.anchor_scales, self.anchor_ratios, [self.sample_duration])
