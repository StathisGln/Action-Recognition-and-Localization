...
from act_linear_wrapper import _RNN_wrapper
...
if __name__ == '__main__':
    ...
    # dataset_features = './JHMDB-features-256-3-1/'
    # dataset_features = './JHMDB-features-256-8-2/'
    dataset_features = './JHMDB-features-16-256-32-8'
    # dataset_features = './JHMDB-features-16-256-16-4'
    ...
    model =_RNN_wrapper(256*sample_duration*7*7,128,len(actions), 256, sample_duration)
    ...
    for epoch in range(epochs):
        ...
        if ( epoch + 1 ) % 20 == 0:
            torch.save(model.module.act_rnn.state_dict(), "linear_mean_jhmdb_{}.pwf".format(epoch+1))
            # torch.save(model.module.act_rnn.state_dict(), "linear_max_jhmdb_{}.pwf".format(epoch+1))
