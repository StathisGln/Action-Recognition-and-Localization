...
from act_linear_wrapper_ucf import _RNN_wrapper
...
if __name__ == '__main__':
    ...
    model =_RNN_wrapper(256*7*7,128,len(actions), 256, sample_duration)
    ...
    for epoch in range(epochs):
        ...
        if ( epoch + 1 ) % 20 == 0:
            torch.save(model.module.act_rnn.state_dict(), "linear_mean_ucf_{}.pwf".format(epoch+1))
