...
from lib.dataloaders.jhmdb_dataset import  video_names, RNN_JHMDB
...
from lib.models.act_rnn_wrapper import _RNN_wrapper
...
if __name__ == '__main__':
    ...
    file = open('../images_etc/train_loss_jhmdb_linear.txt', 'w')
