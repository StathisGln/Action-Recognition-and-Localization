...
from act_mlp_wrapper import _RNN_wrapper
...
if __name__ == '__main__':
    ...
    for epoch in range(epochs):
        ...
        if ( epoch + 1 ) % 20 == 0:
            torch.save(model.module.act_rnn.state_dict(), "mpl_ucf_{}.pwf".format(epoch+1))
            # torch.save(model.module.act_rnn.state_dict(), "linear_max_jhmdb_{}.pwf".format(epoch+1))

    torch.save(model.module.act_rnn.state_dict(), "mpl_ucf_{}.pwf".format(epoch+1))
    # torch.save(model.module.act_rnn.state_dict(), "linear_max_mdb_{}.pwf".format(epoch+1))
