...
# from model_all_linear import Model
from model_all_linear_nms import Model
...
if __name__ == '__main__':
    ...
    parser.add_argument('--linear_path', '-l', help='Path of linear model', default='./linear_mean_jhmdb_60.pwf' )
    ...
    # linear_path = './linear_mean_jhmdb_60.pwf'
