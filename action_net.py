...
from R2Plus1D_model import R2Plus1DNet
...
class ACT_net(nn.Module):
    ...
    def _init_modules(self):
        ...
        self.act_base_1 = nn.Sequential(model.module.conv1, model.module.conv2)
        self.act_base_2 = nn.Sequential(model.module.conv3, model.module.conv4)
