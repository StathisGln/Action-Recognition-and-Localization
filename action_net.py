...
from human_reg_2d_new import _Regression_Layer
...
class ACT_net(nn.Module):
    ...
    def __init__(self, actions,sample_duration):
        ...
        self.act_proposal_target = _ProposalTargetLayer(sample_duration, self.n_classes).cuda() ## background/ foreground
    ...
    def forward(self, im_data, im_info, gt_tubes, gt_rois,  start_fr, rate):
        ...
        if self.training:
            ...
            roi_data = self.act_proposal_target(rois, gt_rois, rate)

            rois, rois_label, rois_rate, rois_progress, rois_target, rois_inside_ws, rois_outside_ws = roi_data
        ...
        # r_rate, rate_loss, r_prog, prog_loss, cls, cls_loss = self.prg_rt(feats, rois_rate, rois_progress, rois_label)
        ...
        if self.training:
            ...
            #     None, None, None
            # return rois,  feats, rpn_loss_cls, rpn_loss_bbox, rois_rate, None, \
            #     rois_progress, None, None, None,  rois_label, sgl_rois_bbox_pred, sgl_rois_bbox_loss
            return rois,  feats, rpn_loss_cls, rpn_loss_bbox, rois_rate, \
                rois_progress, rois_label, sgl_rois_bbox_pred, sgl_rois_bbox_loss
        ...
        return rois, feats, None, None,   \
            None, None, None, sgl_rois_bbox_pred, None,
