...
# from model_temporal_cls_v3_2 import Model
# from model_temporal_cls_v4 import Model
# from model_temporal_cls_v5 import Model
# from model_temporal_cls_v6 import Model
from model_temporal_cls_v7 import Model
...
def validation(epoch, device, model, dataset_folder, sample_duration, spatial_transform, temporal_transform, boxes_file, splt_txt_path, cls2idx, batch_size, n_threads):
    ...
    # confidence_thresh_7 = 0.1
    # confidence_thresh_8 = 0.15
    ...
    for step, data  in enumerate(data_loader):
        ...
        for i in range(clips.size(0)):
            ...
            print('tub_prob_out :',tub_prob_out)
            print('tub_max_indices :',tub_max_indices)
